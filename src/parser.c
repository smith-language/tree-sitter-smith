...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_1, 685, lookahead)) ADVANCE(18);
      END_STATE();
    case 1:
    ...
    case 18:
      ...
      if (set_contains(sym_identifier_character_set_2, 800, lookahead)) ADVANCE(18);
      END_STATE();
    default:
      return false;
  }
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(2)] = {
    ...
    [sym_not_equal] = ACTIONS(17),
    [sym_less] = ACTIONS(19),
    [sym_less_equal] = ACTIONS(17),
    [sym_greater] = ACTIONS(19),
    [sym_greater_equal] = ACTIONS(17),
    [sym_add] = ACTIONS(17),
    [anon_sym_DASH] = ACTIONS(17),
    [sym_multiply] = ACTIONS(17),
    [sym_divide] = ACTIONS(17),
    [sym_modulo] = ACTIONS(17),
    [sym_not] = ACTIONS(19),
  ...
  [STATE(7)] = {
    ...
    [sym_add] = ACTIONS(21),
    [anon_sym_DASH] = ACTIONS(21),
    [sym_multiply] = ACTIONS(21),
    [sym_divide] = ACTIONS(21),
    [sym_modulo] = ACTIONS(21),
    [sym_not] = ACTIONS(23),
    [anon_sym_LPAREN] = ACTIONS(21),
    [anon_sym_RPAREN] = ACTIONS(21),
    [sym_integer_literal] = ACTIONS(21),
  ...
  [STATE(8)] = {
    ...
    [sym_less] = ACTIONS(39),
    [sym_less_equal] = ACTIONS(37),
    [sym_greater] = ACTIONS(39),
    [sym_greater_equal] = ACTIONS(37),
    [sym_add] = ACTIONS(37),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [64] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  ...
  [107] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_negative, 1, 0, 0),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negative, 1, 0, 0),
  [111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subtract, 1, 0, 0),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subtract, 1, 0, 0),
